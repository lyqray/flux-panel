...
面板端：
```bash
curl -L https://raw.githubusercontent.com/lyqray/flux-panel/refs/heads/1.4.2/panel_install.sh -o panel_install.sh && chmod +x panel_install.sh && ./panel_install.sh
```
节点端：
```bash
curl -L https://raw.githubusercontent.com/lyqray/flux-panel/refs/heads/1.4.2/install.sh -o install.sh && chmod +x install.sh && ./install.sh
```
节点端2（单节点机复用）：
```bash
curl -L https://raw.githubusercontent.com/lyqray/flux-panel/refs/heads/1.4.2/install2.sh -o install2.sh && chmod +x install2.sh && ./install2.sh
